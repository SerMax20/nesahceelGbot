...
async def upload_to_gdrive(file_upload, message, user_id):
    ...
    if os.path.isfile(file_upload):
        ...
        await asyncio.sleep(EDIT_SLEEP_TIME_OUT)
        await message.reply_text(f"🤖: {file_upload} has been Uploaded successfully to your Cloud<a href='tg://user?id={user_id}'>🤒</a>", reply_markup=button_markup)
        ...
        button_markup = pyrogram.InlineKeyboardMarkup(button)
        await asyncio.sleep(EDIT_SLEEP_TIME_OUT)
        await message.reply_text(f"🤖: Folder has been Uploaded successfully to {tt} in your Cloud<a href='tg://user?id={user_id}'>🤒</a>", reply_markup=button_markup)
        #await asyncio.sleep(EDIT_SLEEP_TIME_OUT)
